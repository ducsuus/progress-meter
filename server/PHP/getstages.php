...
try{
    ...
    if (strlen($_GET['code']) === 4 || strlen($_GET['code']) === 20){
        ...
        // Pass in the url code to the statement and use it as a viewcode or a edit code depending on how long it is (which determines what it is)
